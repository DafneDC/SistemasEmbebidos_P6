...
int main(void)
{
	...
	Tiempo.minutes.reg = 0b00110000;
	Tiempo.hours.reg = 0b00100001;
	Tiempo.day.reg = 0b00000001;
	Tiempo.date.reg = 0b00010001;
	Tiempo.month.reg = 0b00000100;
	...
	while(1){
		mysnprintf(buff, sizeof buff, "%x/%x/%x/%x/%x/%x", Tiempo.date.reg, Tiempo.month.reg, Tiempo.year.reg, Tiempo.hours.reg, Tiempo.seconds.reg, Tiempo.minutes.reg);
		myprintf("\n%s",buff);
		receiveI2CDataArray(0x68, SECONDS_ADDR, &Tiempo.seconds.reg, 7);
	}
